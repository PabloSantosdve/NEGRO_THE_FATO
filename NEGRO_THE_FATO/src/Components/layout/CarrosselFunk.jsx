...
const Carrossel = () => { // Declaração do componente funcional Carrossel
  ...
  const images = [
    {
      ...
      link: 'https://www.instagram.com/mchariel/?hl=pt-br', // Link vazio (pode ser preenchido conforme necessário)
    },
    {
      img: 'https://i.pinimg.com/736x/ae/2a/88/ae2a8816a9bfadf357e9835ed63fa1ce.jpg', // URL da segunda imagem
      link: 'https://www.instagram.com/mckevin/?hl=pt-br', // Link vazio (pode ser preenchido conforme necessário)
    },
    {
      img: 'https://i.pinimg.com/736x/7a/0b/f6/7a0bf6dcdbcbdd00ad12b7244df6f28c.jpg', // URL da terceira imagem
      link: 'https://www.instagram.com/anitta/', // Link vazio (pode ser preenchido conforme necessário)
    },
  ...
  return (
    <div className={styles.carrosselContainer}> {/* Container principal do carrossel com estilo importado */}
      <h2 className={styles.title}>Conheça os melhores artistas do Funk</h2> {/* Título do carrossel, com estilo aplicado */}
